...
def portfolio_stats(weights, returns, cov_matrix, risk_free_rate=0.06098):
...
def calculate_downside_std(returns, weights, risk_free_rate=0.06098):
...
def calculate_sortino_ratio(returns, weights, annual_return, risk_free_rate=0.06098):
